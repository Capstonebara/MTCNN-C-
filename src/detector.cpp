...
void MTCNNDetector::faceAlign(cv::Mat& img, std::vector<Face>& faces, std::string savepath)
{
    ...
    for (int i = 0; i < faces.size(); i++)
    {
        ...
        double enlargeFace_landmark[10] = {
            static_cast<double>(new_left_eye_x),
            static_cast<double>(new_right_eye_x),
            static_cast<double>(new_nose_x),
            static_cast<double>(new_left_mouth_x),
            static_cast<double>(new_right_mouth_x),
            static_cast<double>(new_left_eye_y),
            static_cast<double>(new_right_eye_y),
            static_cast<double>(new_nose_y),
            static_cast<double>(new_left_mouth_y),
            static_cast<double>(new_right_mouth_y)
        };
